...
Boolean ind;
System.out.println(sb.getIndian());
if(sb.getIndian()==true)
{
ind=true;
}
else
...
ps.setInt(1,rn);
ps.executeUpdate();
ps=connection.prepareStatement("insert into student(roll_number,name,address,city_code,gender,indian,date_of_birth) values(?,?,?,?,?,?,?)");
ps.setInt(1,rn);
ps.setString(2,nn);
ps.setString(3,aa);
ps.setInt(4,cc);
